...
const products=[
 {id:'tee-01',name:'Custom T-Shirt',image:'custom-tshirt.svg',price:499,category:'T-Shirts',description:'Comfortable everyday tee ready for your custom print.'},
 {id:'tee-02',name:'College Fest T-Shirt',image:'college-fest-tee.svg',price:449,category:'T-Shirts',description:'Bold custom tees for college events and groups.'},
 {id:'tee-03',name:'Oversized Graphic Tee',image:'oversized-graphic-tee.svg',price:599,category:'T-Shirts',description:'Relaxed oversized fit for a modern streetwear look.'},
 {id:'hoodie-01',name:'Premium Custom Hoodie',image:'hoodie.svg',price:999,category:'Hoodies',description:'Soft hoodie suitable for custom prints and embroidery.'},
 {id:'hoodie-02',name:'Royal Embroidery Hoodie',image:'royal-embroidery-hoodie.svg',price:1199,category:'Hoodies',description:'Premium hoodie with a clean embroidered finish.'},
 {id:'cap-01',name:'Embroidered Cap',image:'embroidered-cap.svg',price:399,category:'Caps',description:'Classic cap with custom embroidery.'},
 {id:'cap-02',name:'Logo Dad Cap',image:'logo-dad-cap.svg',price:449,category:'Caps',description:'Minimal everyday cap for custom logos and names.'},
 {id:'uniform-01',name:'Corporate Uniform Set',image:'corporate-uniform.svg',price:1299,category:'Uniforms',description:'Customisable uniform set for teams and businesses.'},
 {id:'uniform-02',name:'School House Uniform',image:'school-house-uniform.svg',price:899,category:'Uniforms',description:'Custom school and group uniforms.'},
 {id:'mens-01',name:"Custom Men's Shirt",image:'custom-mens-shirt.svg',price:699,category:"Men's Wear",description:'Custom-fit men’s shirt with your choice of style, colour and design.'},
 {id:'mens-02',name:'Custom Kurta',image:'custom-mens-kurta.svg',price:899,category:"Men's Wear",description:'Custom kurta tailoring with personalised fit, fabric and design.'},
 {id:'ladies-01',name:'Ladies Blouse',image:'ladies-blouse.svg',price:799,category:'Ladies Wear',description:'Tailored blouse with options for custom design.'},
 {id:'ladies-02',name:"Custom Women's Wear",image:'custom-womens-wear.svg',price:999,category:"Women's Wear",description:'Custom women’s wear tailored to your measurements, style and design.'},
 {id:'ladies-03',name:'Custom Blouse Design',image:'custom-womens-blouse.svg',price:899,category:"Women's Wear",description:'Choose your blouse style, neck pattern, sleeves and embroidery details.'},
 {id:'print-01',name:'T-Shirt Printing',image:'tshirt-printing.svg',price:499,category:'T-Shirt Printing',description:'Print your logo, artwork, text or design on a quality T-shirt.'},
 {id:'print-02',name:'Photo / Name T-Shirt Printing',image:'photo-tshirt-printing.svg',price:549,category:'T-Shirt Printing',description:'Personalised photo, name or message printing for gifts and occasions.'},
 {id:'accessory-01',name:'Custom Tote Bag',image:'tote-bag.svg',price:299,category:'Accessories',description:'Reusable tote bag for custom printing.'},
 {id:'accessory-02',name:'Embroidered Tote',image:'embroidered-tote.svg',price:399,category:'Accessories',description:'Tote bag with a custom embroidered design.'}
];
